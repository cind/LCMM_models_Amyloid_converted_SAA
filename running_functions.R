...
meta_ROI_test <- lcmm::predictY(meta_ROI_splines, datnew, var.time = "adjusted_new_time", draws = TRUE)
...
hippocampal_test <- lcmm::predictY(hippocampal_splines, datnew, var.time = "adjusted_new_time", draws = TRUE)
...
centiloid_test <- lcmm::predictY(centiloid_splines, datnew, var.time = "adjusted_new_time", draws = TRUE)
...
fdg_test <- lcmm::predictY(fdg_splines, datnew, var.time = "adjusted_new_time", draws = TRUE)
...
adas13_test <- lcmm::predictY(adas13_splines, datnew, var.time = "adjusted_new_time", draws = TRUE)
...
mmse_test <- lcmm::predictY(mmse_splines, datnew, var.time = "adjusted_new_time", draws = TRUE)
...
cdrsb_test <- lcmm::predictY(cdrsb_splines, datnew, var.time = "adjusted_new_time", draws = TRUE)
...
mpacctrailsb_test <- lcmm::predictY(mpacctrailsb_splines, datnew, var.time = "adjusted_new_time", draws = TRUE)
...
tau_test <- lcmm::predictY(tau_splines, datnew, var.time = "adjusted_new_time", draws = TRUE)
...
ptau_test <- lcmm::predictY(ptau_splines, datnew, var.time = "adjusted_new_time", draws = TRUE)
...
abeta_test <- lcmm::predictY(abeta_splines, datnew, var.time = "adjusted_new_time", draws = TRUE)
...
ecog_s_test <- lcmm::predictY(ecog_s_splines, datnew, var.time = "adjusted_new_time", draws = TRUE)
...
ecog_p_test <- lcmm::predictY(ecog_p_splines, datnew, var.time = "adjusted_new_time", draws = TRUE)
